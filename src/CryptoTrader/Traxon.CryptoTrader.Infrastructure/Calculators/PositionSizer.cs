...
{
    private const decimal MinEdge             = 0.02m; // Loop12: ensemble scoring handles quality
    private const decimal MinEdgeLowVol      = 0.02m; // Loop12: ensemble scoring handles quality
