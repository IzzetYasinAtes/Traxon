...
public sealed class Asset : ValueObject
{
    ...
    public static readonly IReadOnlyList<Asset> All = [BTCUSDT, ETHUSDT, SOLUSDT, XRPUSDT, DOGEUSDT, BNBUSDT, HYPEUSDT];

    /// <summary>Aktif trade edilebilir asset'ler.</summary>
    public static readonly IReadOnlyList<Asset> Tradeable = All;
